...
void createMenu(GUI *gui)
{
       switch(gui->display)
       {
              ...
              case 1:
              {
                     ...
                     for(int i=0;i<3;i++)
                     {
                            gui->spritesStarship[i].setPosition(Vector2f(10+i*200, 150));
                            gui->buttons[i].setPosition(Vector2f(35+i*200, 390));
                     ...
                     gui->labels[0].setPosition(Vector2f(50, 402));
                     gui->labels[1].setPosition(Vector2f(250, 402));
                     gui->labels[2].setPosition(Vector2f(450, 402));
              }
              break;
       }
}
